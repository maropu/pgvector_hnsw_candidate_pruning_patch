...
# -*- coding: utf-8 -*-
"""
gen_hnswhp.py — generator for pgvector/src/hnswhp.c
...
def emit_c_file(out_path: str, R: np.ndarray, bits: int, dim: int, seed: int):
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        f.write("#include \"hnswmeta.h\"\n\n")

        # Matrix constant: [bits][dim]
        f.write("/* Random hyperplanes: shape [HNSW_NEIGHBOR_SIMHASH_MAX_BITS][HNSW_MAX_DIM] */\n")
        f.write("const float hnsw_neighbor_simhash_r[HNSW_NEIGHBOR_SIMHASH_MAX_BITS][HNSW_MAX_DIM] = {\n")
        for i in range(bits):
