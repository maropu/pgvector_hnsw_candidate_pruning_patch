...
run_sift1m_footprint_benchmark.py - run benchmark to monitor DB block footprint
  ...
  - Connect to a specified DB (TCP when --host is given, UNIX socket otherwise)
...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--host", default=None,
                    help="PostgreSQL host (default: UNIX socket). Use 'localhost' for a Docker container.")
    ap.add_argument("--port", type=int, default=5432, help="PostgreSQL port (default: 5432)")
...
def main():
    ...
    # Connect via TCP when --host is given, UNIX socket otherwise.
